...
(
    ...
    `head_url`    varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '头像URL（外链）',
    `head_path`   varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '头像路径（相对路径）',
...
(
    ...
    `update_time` datetime(0)                                                   NULL DEFAULT NULL COMMENT '更新时间',
    `dept_id`     bigint(20)                                                    NULL DEFAULT NULL COMMENT '部门ID',
    `code`        varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL DEFAULT NULL COMMENT '类别编码',
...
(
    ...
    `name`        varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '区域名称',
    `weight`      int(11)                                                      NULL DEFAULT NULL COMMENT '顺序，越小优先级越高',
...
(
    ...
    `update_by`   varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci   NULL DEFAULT NULL COMMENT '更新者',
    `update_time` datetime(0)                                                    NULL DEFAULT NULL COMMENT '更新时间',
    `key`         varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci   NULL DEFAULT NULL COMMENT '参数键',
...
(
    ...
    `url`          varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'URL（外链）',
    `path`         varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '路径（相对路径）',
    `bucket_type`  tinyint(1)                                                    NULL DEFAULT NULL COMMENT '空间类型 0：私有 1：公有',
    `support_type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL DEFAULT NULL COMMENT '支持类型 LOCAL：本地服务器存储 MIN_IO：MinIo对象存储 QI_NIU：七牛云对象存储',
    PRIMARY KEY (`id`) USING BTREE,
    INDEX `idx_create_time` (`create_time`) USING BTREE
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
...
(
    ...
    `update_time`  datetime(0)                                                   NULL DEFAULT NULL COMMENT '更新时间',
    `dept_id`      bigint(20)                                                    NULL DEFAULT NULL COMMENT '部门ID',
    `name`         varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci  NULL DEFAULT NULL COMMENT '邮件名称',
    `subject`      varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '邮件标题',
    `content`      text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci         NULL COMMENT '邮件正文',
