...
public class SecurityPostController {
    ...
    public Result<List<SecurityPostDto>> list() {
        return Result.ok(mainService.list(1));
    }
    ...
    public Result<Void> add(@Validated(AddGroup.class) SecurityPostDto dto) {
        mainService.add(dto);
        return Result.ok();
    }
    ...
    public Result<Void> update(@Validated(UpdateGroup.class) SecurityPostDto dto) {
