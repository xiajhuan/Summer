...
public class DictionaryCategoryController {
    ...
    public Result<Void> add(@Validated(AddGroup.class) DictionaryCategoryDto dto) {
        mainService.add(dto);
        return Result.ok();
    }
    ...
    public Result<Void> update(@Validated(UpdateGroup.class) DictionaryCategoryDto dto) {
