 ...
 * @date 2023/5/9
 */
public interface LogMailService extends IService<LogMailEntity> {

    Page<LogMailDto> page(LogMailDto dto);
     ...
     * @return 记录数
     */
    long count(LogMailDto dto);

    /**
     * 异步保存
     *
     * @param entity 邮件日志Entity
     */
    @Async(ThreadPoolConst.ASYNC_COMMON)
    void saveAsync(LogMailEntity entity);
