...
public class GlobalExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    public Result<Void> handleSystemOrBusinessException(RuntimeException e) {
    ...
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    public Result<Void> handleFileUploadOrDownloadException(RuntimeException e) {
        String msg = e.getMessage();
        LOGGER.error(e, msg);
        return Result.fail(msg);
    }
     ...
     * @return 响应结果
     */
    private Result<Void> logAndResponse(Exception e, boolean isSaveErrorLog) {
